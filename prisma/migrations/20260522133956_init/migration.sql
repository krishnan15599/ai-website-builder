...
-- CreateIndex
CREATE INDEX "website_versions_projectId_idx" ON "website_versions"("projectId");
...
-- AddForeignKey
ALTER TABLE "website_versions" ADD CONSTRAINT "website_versions_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "projects"("id") ON DELETE CASCADE ON UPDATE CASCADE;
